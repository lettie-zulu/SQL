...
FROM 'C:\Users\letti\Documents\bootcamp\SQL\chapter9\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\Users\letti\Documents\bootcamp\SQL\chapter9\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
