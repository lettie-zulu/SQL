...
FROM 'C:\Users\letti\Documents\bootcamp\SQL\chapter13\crime_reports.csv'
...
SET date_1 = (
    TO_TIMESTAMP(
        ...
        || ' ' ||
        (regexp_match(original_text, '(\d{2})(\d{2}) hrs'))[1]
        || ':' ||
        (regexp_match(original_text, '(\d{2})(\d{2}) hrs'))[2]
        || ':00',
        'MM/DD/YY HH24:MI:SS'
...
FROM 'C:\Users\letti\Documents\bootcamp\SQL\chapter13\sotu-1946-1977.csv'
